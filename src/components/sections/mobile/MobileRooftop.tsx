...
import styles from './MobileRooftop.module.css';
import { Button } from '../../ui/Button';
import { Reveal } from '../../ui/Reveal';
import { Sticker } from '../../stickers/Sticker';

export const MobileRooftop: React.FC = () => {
  return (
    <section id="rooftop" className={styles.section}>
      <div className={`container ${styles.container}`}>
        
        <Reveal animation="clip-up" duration={800} className={styles.imageWrapper}>
          <img 
        ...
        <Reveal animation="fade-up" delay={200} className={styles.content}>
          ...
          <div className={styles.actions}>
            <Button variant="primary" size="lg" className={styles.button}>Explore Rooftop</Button>
          </div>
        </Reveal>
